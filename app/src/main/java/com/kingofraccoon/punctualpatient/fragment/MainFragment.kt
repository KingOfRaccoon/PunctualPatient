...
class MainFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener {
            when(it.itemId){
                R.id.writeTalon -> requireFragmentManager().setFragment(FilterTalonFragment(), FilterTalonFragment.tag)
                R.id.profile -> requireFragmentManager().setFragment(ProfileFragment(), ProfileFragment.tag)
            }
